...
class SampleRewardedCustomEventLoader private constructor(
    ...
    companion object{
        ...
        fun getInstance(maxAdapterResponseParameters: MaxAdapterResponseParameters?, activity: Activity?,
                        callback: MaxRewardedAdapterListener): SampleRewardedCustomEventLoader {
            return INSTANCE ?: synchronized(this) {
                INSTANCE ?: SampleRewardedCustomEventLoader(maxAdapterResponseParameters,activity,callback).also {
                    INSTANCE = it
                }
            }
        }

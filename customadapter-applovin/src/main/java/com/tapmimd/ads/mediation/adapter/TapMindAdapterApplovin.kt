...
class TapMindAdapterApplovin(appLovinSdk: AppLovinSdk) : MediationAdapterBase(appLovinSdk),
    ...
    override fun initialize(
        ...
        Toast.makeText(activity, "AppLovin initialize", Toast.LENGTH_SHORT).show()
        callback?.onCompletion(InitializationStatus.INITIALIZED_SUCCESS, null)
    }

    override fun getSdkVersion(): String {
        Log.d(TAG, "getSdkVersion: AppLovin 321")
        return "1.0.0"
    }

    override fun getAdapterVersion(): String {
        Log.d(TAG, "getAdapterVersion: AppLovin 321")
        return "1.0.0"
    }

    override fun onDestroy() {
        Log.d(TAG, "onDestroy: AppLovin 321")
    }

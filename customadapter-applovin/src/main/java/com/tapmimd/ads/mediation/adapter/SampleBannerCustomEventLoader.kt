...
class SampleBannerCustomEventLoader private constructor(
    ...
    private val TAG = "APP@@@"
    private val TAG1 = "SampleBannerCustomEventLoader"
    companion object{

        @SuppressLint("StaticFieldLeak")
        @Volatile
        private var INSTANCE: SampleBannerCustomEventLoader? = null

        fun getInstance(maxAdapterResponseParameters: MaxAdapterResponseParameters,
                        maxAdFormat: MaxAdFormat,
                        activity: Activity,
                        maxAdViewAdapterListener: MaxAdViewAdapterListener): SampleBannerCustomEventLoader {
            return INSTANCE ?: synchronized(this) {
                INSTANCE ?: SampleBannerCustomEventLoader(maxAdapterResponseParameters,maxAdFormat,activity,maxAdViewAdapterListener).also {
                    INSTANCE = it
                }
            }
        }

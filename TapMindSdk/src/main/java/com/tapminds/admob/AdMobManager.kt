                ...
                object : InterstitialAdLoadCallback() {
                    ...
                    override fun onAdLoaded(ad: InterstitialAd) {
                        ...
                        interstitialAd?.fullScreenContentCallback =
                            InterstitialAdListener(placementId, listener)
            ...
            RewardedAd.load(
                ...
                object : RewardedAdLoadCallback() {
                    ...
                    override fun onAdLoaded(ad: RewardedAd) {
                        ...
                        rewardedAd = ad
                        rewardedAdListener = RewardedAdListener(placementId, listener)
...
//    }
    ...
    fun loadNativeAd(
        ...
        Log.d(
            TAG,
            "Loading ${if (isBiddingAd) "bidding " else ""}native ad for placement id: $placementId"
        )
        ...
        fun loadAt(index: Int) {
            ...
            val nativeAdListener = object : NativeAdListener(parameters, context, listener) {
                ...
                override fun onAdFailedToLoad(loadAdError: LoadAdError) {
                    ...
                    loadAt(index + 1) // 👉 TRY NEXT PRIORITY
                }

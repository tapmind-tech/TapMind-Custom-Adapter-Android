...
//
//                    if (activity != null) {
//                        showRewardedAd(parameters, activity, listener)
//                    } else {
//                        listener.onRewardedAdDisplayFailed(
//                            TapMindAdapterError(500, "Activity not found")
//                        )
//                    }
...
//            val adapter = sortedAdapters[index]
        ...
        val adSize = if (isGAM) {
            if (context != null) {
                bannerAdSize(context, width, height, parameters)
            } else {
                AdSize.BANNER
            }
        } else {
        ...
        if (isGAM) {
            if (context == null) return
            val adView = com.google.android.gms.ads.admanager.AdManagerAdView(context).apply {
                setAdSizes(adSize)

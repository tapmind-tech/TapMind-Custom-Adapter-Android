        ...
        override fun onNativeAdLoaded(nativeAd: NativeAd) {
            ...
            runOnUiThread {
                try {
                    ...
                    // ✅ CRITICAL: Handle media content properly
                    val mediaContent = nativeAd.mediaContent
                    if (mediaContent != null) {
                        Log.d(TAG, "$TAG1 MediaContent available - hasVideo: ${mediaContent.hasVideoContent()}")
        ...
        override fun prepareForInteraction(
            ...
            try {
                ...
                if (container is TapMindNativeAdView) {
                    ...
                    val hasPluginLayout = pluginContainer is RelativeLayout || pluginContainer is FrameLayout
                    ...
                    if (mediaView != null) {
                        ...
                        if (mediaView is MediaView) {
                            ...
                            nativeAd.mediaContent?.let { content ->
                                mediaView.setMediaContent(content)
                                Log.d(TAG, "$TAG1 MediaContent set on MediaView")
                            }
                        }
                    ...
                    if (hasPluginLayout) {
                        ...
                        nativeAdView.measure(
                            View.MeasureSpec.makeMeasureSpec(pluginContainer.width, View.MeasureSpec.EXACTLY),
                            View.MeasureSpec.makeMeasureSpec(pluginContainer.height, View.MeasureSpec.EXACTLY)
                        )

...
//        })
    ...
    override fun loadBannerAd(
        ...
        val placementName = getPlacement(adConfig.serverParameters, "tapminds_banner")
    ...
    override fun loadNativeAdMapper(
        ...
        val placementName = getPlacement(adConfig.serverParameters, "tapminds_native")
    ...
    override fun loadInterstitialAd(
        ...
        val context = adConfig.context
        val placementName = getPlacement(adConfig.serverParameters, "tapminds_interstitial")
        val appData = getAppInfo(context)
        val country = Locale.getDefault().country
        val geo = GeoProviderAdMob.get(country)
    ...
    override fun loadAppOpenAd(
        ...
        val context = adConfig.context
        val placementName = getPlacement(adConfig.serverParameters, "tapminds_AppOpen")
        val appData = getAppInfo(context)
        val country = Locale.getDefault().country
        val geo = GeoProviderAdMob.get(country)
    ...
    override fun loadRewardedAd(
        ...
        val context = adConfig.context
        val placementName = getPlacement(adConfig.serverParameters, "tapminds_reward")
        val appData = getAppInfo(context)
        val country = Locale.getDefault().country
        val geo = GeoProviderAdMob.get(country)
    ...
    override fun loadRewardedInterstitialAd(
        ...
        val context = adConfig.context
        val placementName = getPlacement(adConfig.serverParameters, "tapminds_RewardedInterstitial")
        val appData = getAppInfo(context)
        val country = Locale.getDefault().country
        val geo = GeoProviderAdMob.get(country)
    ...
    private fun getPlacement(serverParameters: Bundle?, default: String): String {
        return runCatching {
            Log.e(TAG, "getPlacement: $serverParameters")
            serverParameters?.getString("parameter")?.let {
                JSONObject(it).optString("placementName")
                    .ifEmpty { JSONObject(it).optString("placement_id") }
            }.orEmpty()
                .ifEmpty { serverParameters?.getString("label").orEmpty() }
                .ifEmpty { default }

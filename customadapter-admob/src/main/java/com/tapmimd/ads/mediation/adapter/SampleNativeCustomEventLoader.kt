...
class SampleNativeCustomEventLoader private constructor(
    ...
    private val TAG = "APP@@@"
    private val TAG1 = "SampleNativeCustomEventLoader"
    ...
    companion object {
        ...
        fun getInstance(
            ...
            return INSTANCE ?: synchronized(this) {
                INSTANCE ?: SampleNativeCustomEventLoader(adConfig, loadCallback).also {
                    INSTANCE = it
                }
            }
        }
        ...
        TapMindsMediationAdapter.getInstance(adConfig.context).loadNativeAd(
            ...
            object : TapMindNativeAdAdapterListener {
                ...
                override fun onNativeAdLoaded(tapMindNativeAd: TapMindNativeAd?, bundle: Bundle?) {
                    ...
                    tapMindNativeAd?.let {
                        val mapper = SampleUnifiedNativeAdMapper(tapMindNativeAd)

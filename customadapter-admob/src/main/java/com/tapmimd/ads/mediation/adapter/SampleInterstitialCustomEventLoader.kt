...
//    private var sampleAd: SampleInterstitialAd? = null
    ...
    companion object {
        ...
        fun getInstance(
            ...
            return INSTANCE ?: synchronized(this) {
                INSTANCE ?: SampleInterstitialCustomEventLoader(adConfig, loadCallback).also {
                    INSTANCE = it
                }
            }
        }
        ...
        tapMindInterstitialAdapterListener = object : TapMindInterstitialAdapterListener {
            override fun onInterstitialAdLoaded() {
                returnedInterstitial =
                    TapMindAdmobInterstitialReturned(this@SampleInterstitialCustomEventLoader)

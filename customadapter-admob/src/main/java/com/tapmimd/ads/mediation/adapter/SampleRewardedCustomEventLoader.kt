...
class SampleRewardedCustomEventLoader(
    ...
    private val TAG = "APP@@@"
    private val TAG1 = "SampleRewardedCustomEventLoader"
    ...
    companion object{
        ...
        @Volatile
        private var INSTANCE: SampleRewardedCustomEventLoader? = null

        fun getInstance(adConfig: MediationRewardedAdConfiguration,callback: MediationAdLoadCallback<MediationRewardedAd?, MediationRewardedAdCallback?>): SampleRewardedCustomEventLoader {
            return INSTANCE ?: synchronized(this) {
                INSTANCE ?: SampleRewardedCustomEventLoader(adConfig,callback).also {
                    INSTANCE = it
                }
            }
        }
    ...
    fun loadAd() {
        ...
        tapMindRewardedAdapterListener = object : TapMindRewardedAdapterListener{
            override fun onRewardedAdLoaded() {
                returnedRewarded = TapMindAdmobRewardedReturned(this@SampleRewardedCustomEventLoader)
            ...
            override fun onRewardedAdLoadFailed(error: TapMindAdapterError) {
                ...
                loadCallback.onFailure(AdError(error!!.getErrorCode(), error.getMessage(),"SampleRewardedCustomEventLoader"))
            }
            ...
            override fun onRewardedAdDisplayFailed(error: TapMindAdapterError?) {
                ...
                callback?.onAdFailedToShow(AdError(error!!.getErrorCode(), error.getMessage(),"SampleRewardedCustomEventLoader"))
            }

...
class SampleAdView(context: Context) : FrameLayout(context) {

    private val TAG = "APP@@@"

    private var adUnitId: String? = null
    private var adSize: SampleAdSize? = null
    private var adListener: SampleAdListener? = null
    ...
    fun setAdListener(listener: SampleAdListener) {
        adListener = listener
    }
...
//        }, 1000)
    ...
    private fun createDummyBanner(isSuccess : Int) {
        ...
        val banner = TextView(context).apply {
            text = "Sample Banner Ad $isSuccess"

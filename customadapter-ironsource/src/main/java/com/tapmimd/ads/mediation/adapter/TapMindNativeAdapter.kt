...
//                            val adapterNativeAdData = SampleUnifiedNativeAdMapperIronSouce(tapMindNativeAd)
//                            val adapterNativeAdViewBinder = SampleUnifiedNativeAdBinderIronSouce(tapMindNativeAd)
